 ...
 * Display
 *
 *  https://documentation.espressif.com/projects/esp-idf/en/latest/esp32s3/api-reference/peripherals/lcd/index.html
 *  https://github.com/espressif/esp-idf/tree/95b6f323/examples/peripherals/lcd/i2c_oled
 *
 * Peter Houwen, december 2025
 * 
 */
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define EXAMPLE_LCD_PIXEL_CLOCK_HZ    (500 * 1000) //(400 * 1000)
...
int init_display( )
{
    ...
    /* Power on display */
#if CONFIG_HELTEC_WIFI_LORA_32_V3
    ESP_LOGI(TAG, "Power on display");
    gpio_reset_pin( VEXT_CTRL_GPIO );
    gpio_set_direction( VEXT_CTRL_GPIO, GPIO_MODE_OUTPUT );
    gpio_set_level( VEXT_CTRL_GPIO, 0 );
